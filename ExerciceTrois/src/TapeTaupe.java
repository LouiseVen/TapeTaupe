...
public class TapeTaupe extends Canvas implements MouseListener {
	...
	TapeTaupe(){
		...
		score = 0;
		 gameTimer = new Timer(gameDuration * 1000, new ActionListener() {
	...
	public static void main(String[] args) {
        ...
        frame.add(canvas);
        frame.setSize(400, 400); // Définir la taille de la fenêtre
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        
        
        canvas.timerLabel = new JLabel("Time Remaining: " + canvas.gameDuration + " seconds");
        canvas.timerLabel.setFont(new Font("Arial", Font.BOLD, 16));
        canvas.timerLabel.setBounds(20, 10, 200, 30);
        frame.add(canvas.timerLabel);
